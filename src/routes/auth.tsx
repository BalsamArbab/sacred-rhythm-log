      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            A calm space to track your worship
          </p>
        </div>
        ...
        <NeuCard className="space-y-5">
          ...
          >
            <svg className="h-4 w-4 mr-2" viewBox="0 0 48 48">
              ...
              <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4 5.6l6.3 5.3C41.4 35.8 44 30.4 44 24c0-1.3-.1-2.3-.4-3.5z"/>
            </svg>
