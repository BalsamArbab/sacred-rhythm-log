...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      habits: {
        Row: {
          ...
          created_at: string;
          id: string;
          menstruation_behavior: Database["public"]["Enums"]["menstruation_behavior"] | null;
          name: string;
          name_ar: string | null;
          quran_tracking_mode: Database["public"]["Enums"]["quran_tracking_mode"] | null;
          recurrence_data: Json;
          recurrence_type: Database["public"]["Enums"]["recurrence_type"];
          sort_order: number;
    ...
    Enums: {
      ...
      menstruation_behavior: "always_pause" | "never_pause" | "depends_on_madhab";
